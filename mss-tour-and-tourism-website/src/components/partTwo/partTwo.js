    ...
    const Places=(props)=>{
      return(
        <Box sx={{ display:'flex',direction:'row' }}>
           ...
           <Box > < img src={props.image} style={{ width:600,height:300 }}/></Box>
       ...
       return(
        ...
        //  display:'flex',
         ...
         padding:'20px'
          ...
          <p style={{ fontSize:'30px' }}>Ethiopia is the “Land of Thirteen Months”. It’s a magical country with ancient and spiritual roots, rich in significant religious history and that has a fabulous story to tell. The beauty of wild mountains is only surpassed by the awe-inspiring religious architecture that draws visitors to this amazing country. It’s where legends of the Ark of the Covenant live side by side and in harmony with ancient Islamic mosques. From thundering waterfalls to its vibrant and modern capital city, Addis Ababa, Ethiopia is a place you have to see to believe. Here are 10 of the best and most incredible places to visit in Ethiopia.
          </p>
